...
Try {
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'netbeans64' -CloseAppsCountdown 60
		...
		$exitCode = Execute-Process -Path "$envProgramFiles\Netbeans-12.0\uninstall.exe" -Parameters '--silent' -WindowStyle 'Hidden'
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
